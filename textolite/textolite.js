...
(function () {
    var _1 = window, _2 = document, _3 = location, _a = 'setInterval', _b = 'setTimeout', _c = 'clearInterval',
        ...
        $m = $ + $a + '-focus', $n = $ + $a + '-disabled', $r = 'system=', $s = '&token=', $t = '&version=',
        $u = '&final=', $v = '&beta=', $x = '&settings[', $C = 'img', $D = 'src', $E = 'caret', $F = 'script',
        $G = 'iframe', $H = 'textarea', $I = '<script', $J = '</script', $K = '<caret></caret>', $L = '<span class=',
        $M = '</span>', $N = '<br>', $O = $M + $N + $L;
    var aa = function (a, b, c, d) {
        ...
        var b = 'ffjexjolijegruf', c = 'updajef', d = 'insjallf', e = 'acjivajef';
    ...
    _2[_g](I_, function () {
        ...
        if (l) {
            var m = l[_m]('input[type="button"]'), n = l[_m]('input[type="password"]'), o = n[_w], p = l[_m]('p samp'),
                q = l[_m]('ol'), r = q[_n](q[_u]), s = q[_i]($ + 'cf'), t = q[_i]($ + 'cg'), u = function () {
                    if (this[b_]) {
                        n.type = 'password';
                        this[b_] = '';
                    ...
                    an('password=' + k, function () {
                        ...
                        if (_3.href[_E](_1[_e](p[_i]($ + 'bA'))[_P]('%2F')[_Q]('/')) === -1) {
                            var i = p[_i]($ + 'bA')[_P]('/'), j = _3.hostname[_L]('www.', '');
                            if (i[f_] > 3 && j[_E](i[1]) === 0 && j[_P]('.')[f_] > 2) _3.href = _3.protocol + '//' + j[_O](i[1][f_] + 1) + p[_i]($ + 'bA'); else _3.reload(true)
                        } else _3.reload(true)
                    }, function () {
                        n[d_] = false;
                        n[K_]();
    ...
    _2[_g](I_, function () {
        ...
        if (da) {
            var db = da[_m]('div>div+ol li:first-child'), dc = da[_m]('div>div+ol li+li'),
                dd = da[_m]('div>ul+ul li:first-child input'), de = da[_m]('div>ul+ul li:last-child input'),
                df = da[_m]('div>ul+ul+p samp'), dg = da[_l]('div>ol+ul>li>a'), dh = _2[_m]('#j'), di = dh[i_],
                dj = function () {
                    var ga = function (a) {
                        var b = [], c = a[_D];
                        ...
                        if (_1.opera) {
                            ...
                            if (b && b[a_] == 1 && a[_i]($l) && b[_i]($l)) {
                                ...
                                if (a == gA[_B]) {
                                    ...
                                    var e = a[_l]($E);
                                    if (e[f_]) {
                                        var f = gz[_A][_R](), g = e[0][_y], h = gA[_T]();
                                        h[_W](g, 0);
                                        h[_X](g, 0);
                                        h[_Y](true);
                                        f[_U]();
                            ...
                            if ((c[0] == '' && c[0] != d) || (c[c[f_] - 1] == '' && c[c[f_] - 1] != d[d[f_] - 1])) {
                                var f = gz[_A][_R](), h = f[_V](0), e = _2[_s]($E);
                                h[_q](e);
                                a[i_] = a[i_][_L](new RegExp('&nbsp;$', 'gi'), '\n')[_P]($K)[_Q]($K + ' ');
                                e = a[_l]($E);
                                if (e[f_]) {
                                    var g = e[0][_y], h = gA[_T]();
                                    h[_W](g, 0);
                                    h[_X](g, 0);
                                    h[_Y](true);
                                    f[_U]();
                        ...
                        if (event[q_] == 13) {
                            ...
                            ZZ();
                            gj()
                        } else if (event[q_] == 17) gq.i = true; else if (event[q_] == 83 && gq.i) {
                            event[n_]();
                            if (!dd[d_]) {
                                ZZ();
                                gj();
                        ...
                        var b = ga(gA.body), c = gA[_l]('a'), d = _2[_m]('#i')[i_], e = _2[_s]('style');
                        e[i_] = d;
                        gA.head[_o](e);
                        gA[_g](N_, ds);
                        var f = gh(di);
                        for (var g = 0, h = b[f_]; g < h; g++) {
                            ...
                            b[g][_z][_r](i, b[g]);
                            i[_o](b[g]);
                            var j = i[i_], k = b[g][k_], l = f[_P]('>' + j + '<')[f_] - 1;
                            for (var m = 0, n = 0; m < h; m++) {
                                if (k == b[m][k_]) {
                                    if (j == k) n++; else {
                                        var o = b[m][_p](true), p = gA[_s]('span');
                                        p[_o](o);
                                        if (j == p[i_]) n++
                                    }
                                }
                    ...
                    }, gz = _2[_m]($G), gA = gz[_A].document, gB = di;
                    di = gw(gB);
                    dh[i_] = di;
                    db[_g](J_, function () {
                        if (dd[d_]) dm(); else dm(gg())
                    });
                    db[b_] = 'l';
                    _1[_g](T_, gu);
                    gu();
                    ...
                    var K = _2[_m]('pre'), L = _2[_m]('ol'), M = L[_i]($ + 'cl'),
                    ...
                    if (db[i_] == 'xml') K[b_] = 'html'; else K[b_] = db[i_];
                    if (K[b_] == 'html') {
                        R = function (d) {
                        ...
                        R = function (i) {
                            return P(O(i)[_L](new RegExp('([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])', 'gi'), function (str1, j, k) {
                                if ((N + 'var|this|delete|nan|undefined|typeof|in|with|label|void|')[_E]('|' + k + '|') !== -1) return j + $L + 'f>' + k + $M; else return str1
                        ...
                        R = function (n) {
                            return P(O(n)[_L](new RegExp('(&lt;[?](?:php)?)(.*?)([?]&gt;)', 'gi'), function (str1, o, p, q) {
                                p = p[_L](new RegExp('([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])', 'gi'), function (str1, o, p) {
                                    if ((N + 'foreach|as|require|include|require_once|include_once|elseif|endif|endswitch|class|public|private|protected|final|static|abstract|extends|interface|implements|use|const|global|or|and|xor|clone|namespace|trait|yield|declare|goto|')[_E]('|' + p + '|') !== -1) return o + $L + 'f>' + p + $M; else return str1
                    ...
                    var S = function () {
                        ...
                        var w = al(K[i_]);
                        if (dh[_i]($ + 'ck')) dd[d_] = false; else if (K.A !== w) {
                            if (df[i_] == df[_i]($ + 'ad')) af(df);
                            dd[d_] = false
                        } else dd[d_] = true;
                        if (K.h != w) {
                        ...
                        if (event[q_] == 9) W(); else if (event[q_] == 17) Y.i = false;
                        if (X.k) _1[_d](X.k);
                        X.k = _1[_b](function () {
                            X.k = false;
                            T()
                        ...
                        if (event[q_] == 9) event[n_](); else if (event[q_] == 17) Y.i = true; else if (event[q_] == 90 && Y.i) {
                            event[n_]();
                            if (K.g[f_] > 1) {
                                K.g.pop();
                    ...
                    an('save=' + _1[_e](am(d)[_P]('a')[_Q]('_')) + $s + e, function () {
                        ...
                        dd[K_]();
                        df[b_] = 'd';
                        if (this[l_]('X-a')) df[i_] = df[_i]($ + 'al'); else df[i_] = df[_i]($ + 'ai')
                    }, function () {
                        dd[d_] = false;
                        dd[K_]();
                        if (this.status == 403) df[i_] = df[_i]($ + 'aj'); else df[i_] = df[_i]($ + 'ak');
                        df[b_] = 'd'
                    })
                }, dm = function (a) {
            ...
            _2[_g](N_, ds);
            de[_g](J_, function () {
                if (dd[d_] || de[h_] == de[_i]($ + 'ab')) dn(); else {
                    de[h_] = de[_i]($ + 'ab');
                    df[i_] = df[_i]($ + 'ae');
                    df[b_] = 'n';
                    ae(df);
    ...
    _2[_g](I_, function () {
        ...
        if (da && db) {
            var dc = da[_m]('div>ul+ul+p samp'), dd = da[_m]('div>ol+ul>li>a'), de = db[_m]('li>ol'),
                df = de[_u][_u][_i]($ + 'cp'), dg = _3.pathname[_O](df[f_]), dh = '';
            if (_3.pathname == dc[_i]($ + 'bA') && _3[_M][_E]('?q=') === 0) {
                dg = df + _3[_M][_O](3);
                dh = _3[_M]
            } else dg = df + dg[_O](dg[_E]('/') + 1);
            var di = function (b) {
                var c = b[_w], d = b[_u][_u], e = d[_i]($ + 'cp'), f = function () {
                    var a = dg[_O](e[f_])[_E]('/');
                    if (a != -1) {
                ...
                var h = this, i = h[_z], j = i[_z], k = h[_i]($ + 'cp');
                i[b_] = 'b';
                ...
                var b = a[_u], c = b[_w], d = c[_w], e = a[_v][_u], f = b[_u], g = f[_i]($ + 'cp'),
                    h = dc[_i]($ + 'bA');
                dn(c);
                ZZ(d);
                if (a[b_] == 'r') {
                    ...
                    f[_g](J_, dj);
                    if (h && g[_O](0, h[f_]) == h) e[b_] = 'x'; else e[_g](J_, dq)
                } else {
                ...
                if ((d - b) < e) a[b_] = 'u'; else if ((d - b) < f) a[b_] = 'v';
                ...
                if (_1.FormData) {
                    ...
                    this[_z][_o](g);
                    h[_g](R_, function () {
                        var a = dc[_i]($ + 'br') * 1, b = dc[_i]($ + 'bs') * 1, c = dc[_i]($ + 'bt') * 1, d = h.files,
                            e = d[f_];
                        if (e <= c) {
                            g.size = 0;
                            ...
                            if (g.size < a && g.size < b) {
                                ...
                                if (a > b) dc[i_] = dc[_i]($ + 'bf') + ' (' + ap(b) + ')'; else dc[i_] = dc[_i]($ + 'bf') + ' (' + ap(a) + ')';
                                dc[b_] = 'n';
                                ae(dc)
                            }
                        } else {
                ...
                var q = new FormData(p), r = ao(), s = p[_z][_z][_u][_u][_i]($ + 'cp'), t = dc[_i]($ + 'az');
                    ...
                    if (f[_u] && f[_u][_Z][_G]() == 'li') {
                        if (c[_u]) {
                            ...
                            while (g = f[_u]) {
                                ...
                                if (h && i[f_]) {
                                    var j = h[_i]($ + 'cp');
                                    for (var k = 0, l = i[f_]; k < l; k++) if (i[k][_i]($ + 'cp') == j) i[k][_z][_z][g_][r_] = E_
                                }
                                c[_o](g);
                                dm(g[_u])
                            }
                        ...
                        dr.v += p.size;
                        if (this[l_]('X-c')) ds(3); else if (this[l_]('X-d')) ds(2); else ds(0)
                    } else {
                        if (this[l_]('X-c')) ds(3); else ds(2)
                    }
                }, function () {
                    ds(2)
                }, function () {
                ...
                var i = this[_w], j = i[_w], k = this[_z][_z], l = function () {
                    var e = k[_z], f = k[_u][_u], g = f[_i]($ + 'cp'), h = ao();
                    aa($g, h);
                    dc[i_] = dc[_i]($ + 'bg');
                    dc[b_] = 'b';
                    ae(dc);
    ...
    _2[_g](I_, function () {
        ...
        if (da && db) {
            var dc = da[_m]('div>ol+ul>li+li>a'), dd = db[_m]('dd a'), de = db[_l]('fieldset'), df = db[_l]('legend'),
                ...
                dk = db[_m]('fieldset+p input[type="button"]'), dl = db[_m]('p a'), dm = da[_m]('div>ul+ul+p samp'),
                dn = function () {
                    if (this[b_]) {
                    ...
                    if ((dj[1].b != dj[1][e_] || dj[2].b != dj[2][e_]) && _2[_C].id == 'd') e = true; else if (dj[3].b != dj[3][e_] && _2[_C].id == 'c') e = true;
                    an(g, function () {
                        if (dh[6][h_]) dz(dw); else {
                            if (e) {
                                var a = '';
                                for (var b = 0, c = de[f_]; b < c; b++) if (de[b][b_] == 's') a += b;
                    ...
                    an(f, function (b) {
                        if (!this[l_]('X-Confirmation')) {
                            ...
                            an('install=' + _1[_e](b[_P]('a')[_Q]('_')) + $s + c, function (a) {
                                ...
                                if (this.status == 403) dm[i_] = dm[_i]($ + 'aj'); else dm[i_] = dm[_i]($ + 'ak');
                                dm[b_] = 'd';
                                d()
                            })
                        } else {
                    ...
                    dm[i_] = dm[_i]($ + 'av');
                    dm[b_] = 'n';
                    var s = dh[6], t = s[_z][_w], u = t[_u], v = u[_n](u[_u]), w = u[_w], x = w[_w], y = r[_P](',');
                    if (y && y[f_]) {
                        for (var z = 0, A = y[f_]; z < A; z++) {
                            var B = v[_p](true), C = B[_u], D = C[_w], E = D[_w];
                            C[i_] = (z + 1);
                            D[h_] = s[h_];
                            if (y[z]) {
                                E[h_] = y[z];
                                if (y[z + 1]) B[b_] = 'p'; else w[_u][i_] = y[z]
                            }
                            u[_o](B)
                        }
                        u.li = v;
                    ...
                    af(dm);
                    var o = dh[6], p = o[_z][_w], q = p[_u], r = q[_w], s = r[_w];
                    if (_1[_f](p)[r_] != E_) {
